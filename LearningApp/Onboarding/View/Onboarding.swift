...
struct Onboarding: View {
    ...
    @State var intros: [Intro] = [
        Intro(title: "Welcome Docoder", subTitle: "Take Deep Breaths", description: "Community of passionate coders and learners. Whether you're a seasoned developer or just starting your coding journey.", img: "first", color: Color("Intro1")),
            
        Intro(title: "Stay Creative", subTitle: "Keep Ideas Fresh", description: "Unlock the power of programming right from your smartphone, with hands-on exercises and real-time feedback.", img: "second", color: Color("Intro2")),
            
        Intro(title: "Stay Focused", subTitle: "Create Task List", description: "Empower yourself with the convenience of learning programming languages anytime, anywhere, all from the palm of your hand.", img: "third", color: Color("Intro3")),
        ]
...
#Preview {
    Onboarding(done: .constant(false))
}
